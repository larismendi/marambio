...
if (isset($_GET['IdUnidad'])) {
  $colname_tar = (get_magic_quotes_gpc()) ? $_GET['IdUnidad'] : addslashes($_GET['IdUnidad']);
}

$query_uni = "SELECT u.Nombre FROM unidades u WHERE u.IdUnidad='".$_POST['IdUnidad']."'";
$uni = mysql_query($query_uni, $marambio) or die(mysql_error());
                  ...
                  <tr>
                    <td width="872">					
						<table width="914" border="0" class="datatable">
                            ...
                            <tbody>
                            <?php $ff = 0;
							$query_tar = "SELECT e.Nombre, u.Nombre Usuario, t.* FROM empresas e, tareas t LEFT JOIN usuarios u ON u.IdUsuario=t.IdLider WHERE e.CodEmp=t.IdEmpresa AND t.IdUnidad = '$IdUnidad' ORDER BY e.Nombre, t.IdEmpresa ASC";
                            ...
                            <tr>
                            	<td colspan="8" align="center">No se encontraron reportes asociados.</td>
							</tr>
							<?php	  
							}
							?>
