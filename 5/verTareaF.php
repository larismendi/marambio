...
<?php include("includes/head.php"); ?>
                ...
                <p class="titulo"><a href="tareasFiltradas.php?IdGrupo=<? echo $IdGrupo; ?>"  class="texto_gris">&lt;&lt; Volver </a></p>
                <table border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
                  ...
                  <tr valign="baseline">
                    ...
                    <td bgcolor="#FFFFFF" class="texto_gris"><div align="left"><?php echo $row_data['HorasEstimadas']; ?></div></td>
                  </tr>
                  <tr valign="baseline">
