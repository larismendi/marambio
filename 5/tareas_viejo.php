...
<script type="text/javascript" src="cargarAjax.js"></script>
<script type="text/javascript">
function cargarcon(tipo){
	//cargarAjax('citasDiarias2.php?d='+d+'$m='+m+'&y='+y+'','cargarSelect');
   cargarAjax('selectCon.php?tip='+tipo.value,'cargarSelect');
        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <div align="center">
            	...
            	<table width="429" height="75"  border="1" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
                  <tr>
                  ...
                  <tr>
                    <td>
                    <form method="get" name="form1" action="agregarTareas.php">
                      <table width="100%" align="center">
                        <tr valign="baseline">
                          ...
                          <td width="279">
                          <select name="IdGrupo" class="texto_gris" id="IdGrupo" onChange="MM_jumpMenu('parent',this,0)">
                            <?php if($IdGrupo!='') { ?>
							<option selected value="<?php echo $row_GrupoList['IdGrupo']; ?>">
								<?php echo $row_GrupoList['Nombre']; ?>
                          	</option>
							<?php } else { ?>
							...
							<?php } 
								  do {  
							?>
                            <option value="tareas.php?IdGrupo=<?php echo $row_grupo['IdGrupo']?>"><?php echo $row_grupo['Nombre']?></option>
                            <?php
                        ...
                        <tr valign="baseline">
                          ...
                          <select name="IdEmpresa" class="texto_gris" id="IdEmpresa">
							<?php
                                do {  
                            ?>
                                <option value="<?php echo $row_empresaList['CodEmp']?>">
                                    <?php echo $row_empresaList['Nombre']?>
                                </option>
                            <?php
                        ...
                        <?php } ?>                
                        <tr valign="baseline">
                          <td colspan="2" align="right" nowrap bgcolor="#EAF1FB" class="texto_btgris"><div align="left"></div>                          <?php if($IdGrupo!=0) { ?>
                            <input name="submit" type="submit" class="texto_btgris" value="Siguiente &gt;&gt;">
                            <?php } ?></td>
                        </tr>
                      </table>
                     </form></td>
                  ...
                  <tr>
                  	<td>
                    <form action="cal3.php" method="post"> 
                    	<table width="100%" align="center">
                        <tr valign="baseline">
                          <td width="55" align="right" nowrap bgcolor="#EAF1FB" class="texto_btgris">
                          	<div align="left">Grupo:</div>
                        ...
                        <table border="0">
                            <tr>
                                <td>Buscar dias disponible de: 
                                    <select name="tipo" id="tipo" onChange="javascript:cargarcon(this)" class="fondo_formulario1" >
                ...
                <table width="425"  border="1" cellpadding="1" cellspacing="1" bordercolor="#EAF1FB">
                  <tr>
                ...
                <table width="96%" class="sortable" border="1" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
				  ...
				  ?>
                    ...
                    <td class="texto_gris">
                      <?php 
					echo $row_datosMostrar['Servicio'];
				  ?>
                    </td>
                    <td class="texto_gris">
                      <?php 
