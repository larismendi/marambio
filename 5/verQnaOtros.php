...
$row_super = mysql_fetch_assoc($super);
...
function valida(form)
{
   ...
   <tr>
     <td width="33%"><span class="texto_btgris">Usuario:<?php echo $row_supervisor['Nombre']; ?><br>
      <?php  if ($row_Qna['Quincena'] == '1') {
                        ...
                        ?>. Quincena de <?php 
                                        switch($row_Qna['Mes']){
                                         ...
                                         case '12':
                                            echo "Diciembre";
                                         break; }?> de <?php echo $row_Qna['Anno']; ?></span><span class="textoazul"><br>
       </span></td>
     <td width="44%" valign="bottom"><div align="center"></div></td>
     <td width="23%" valign="top"><div align="right"><a href="hojadeTiempoOtros.php" class="texto_btgris">&lt;&lt; Volver</a></div></td>
   </tr>
</table>
...
<table border="1">
   ...
   ?>
	 ...
	 ?>
      ...
      <td width="52" class="texto_btgris">         <div align="center"><a href="verQnaOtros.php?IdQnaSub=<?php echo $row_QnaSub['IdQnaSub']; ?>&IdQna=<?php echo $row_QnaSub['IdQna']; ?>&todas=1&IdUsuario=<?php echo $row_QnaSub['IdUsuario']; ?>"><img src="images/CheckCerrado.gif" width="22" height="17" border="0"></a><br>
       </div></td>
	 ...
	 ?>
       ...
       <td>
         <div align="center">
           ...
           <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D01" type="text" class="texto_btgris" id="D01" value="<?php echo $row_QnaSub2['D01']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
	   <?php if($row_QnaSub2['D02']!='') { ?>
           ...
           <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D02" type="text" class="texto_btgris" id="D02" value="<?php echo $row_QnaSub2['D02']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
	   <?php if($row_QnaSub2['D03']!='') { ?>
           ...
           <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D03" type="text" class="texto_btgris" id="D03" value="<?php echo $row_QnaSub2['D03']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D04" type="text" class="texto_btgris" id="D04" value="<?php echo $row_QnaSub2['D04']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D05" type="text" class="texto_btgris" id="D05" value="<?php echo $row_QnaSub2['D05']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D06" type="text" class="texto_btgris" id="D06" value="<?php echo $row_QnaSub2['D06']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D07" type="text" class="texto_btgris" id="D07" value="<?php echo $row_QnaSub2['D07']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D08" type="text" class="texto_btgris" id="D08" value="<?php echo $row_QnaSub2['D08']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D09" type="text" class="texto_btgris" id="D09" value="<?php echo $row_QnaSub2['D09']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D10" type="text" class="texto_btgris" id="D10" value="<?php echo $row_QnaSub2['D10']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D11" type="text" class="texto_btgris" id="D11" value="<?php echo $row_QnaSub2['D11']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D12" type="text" class="texto_btgris" id="D12" value="<?php echo $row_QnaSub2['D12']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D13" type="text" class="texto_btgris" id="D13" value="<?php echo $row_QnaSub2['D13']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D14" type="text" class="texto_btgris" id="D14" value="<?php echo $row_QnaSub2['D14']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D15" type="text" class="texto_btgris" id="D15" value="<?php echo $row_QnaSub2['D15']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D16" type="text" class="texto_btgris" id="D16" value="<?php echo $row_QnaSub2['D16']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D17" type="text" class="texto_btgris" id="D17" value="<?php echo $row_QnaSub2['D17']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D18" type="text" class="texto_btgris" id="D18" value="<?php echo $row_QnaSub2['D18']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D19" type="text" class="texto_btgris" id="D19" value="<?php echo $row_QnaSub2['D19']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D20" type="text" class="texto_btgris" id="D20" value="<?php echo $row_QnaSub2['D20']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D21" type="text" class="texto_btgris" id="D21" value="<?php echo $row_QnaSub2['D21']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D22" type="text" class="texto_btgris" id="D22" value="<?php echo $row_QnaSub2['D22']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D23" type="text" class="texto_btgris" id="D23" value="<?php echo $row_QnaSub2['D23']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D24" type="text" class="texto_btgris" id="D24" value="<?php echo $row_QnaSub2['D24']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D25" type="text" class="texto_btgris" id="D25" value="<?php echo $row_QnaSub2['D25']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D26" type="text" class="texto_btgris" id="D26" value="<?php echo $row_QnaSub2['D26']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D27" type="text" class="texto_btgris" id="D27" value="<?php echo $row_QnaSub2['D27']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td><div align="center">
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D28" type="text" class="texto_btgris" id="D28" value="<?php echo $row_QnaSub2['D28']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <?php if($ultimo_dia>=29) { ?>
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D29" type="text" class="texto_btgris" id="D29" value="<?php echo $row_QnaSub2['D29']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php } ?>
       <?php if($NQda==2) { ?>
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D30" type="text" class="texto_btgris" id="D30" value="<?php echo $row_QnaSub2['D30']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php } ?>
       <?php if($NQda==2) { ?>
       ...
       <?php } ?>
           <br>
           <input <?php if($row_mostrarAdm['Nombre']==""){ echo "readonly='true'"; }?> name="D31" type="text" class="texto_btgris" id="D31" value="<?php echo $row_QnaSub2['D31']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php } ?>
       <td><div align="center">
