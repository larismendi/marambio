...
$departamento2000=$row_supervisor['IdUnidad'];

$IdUsuario2000=$row_supervisor['IdUsuario'];
$query_data = "SELECT * FROM quincenas ORDER BY IdQna DESC";
$data = mysql_query($query_data, $marambio) or die(mysql_error());
$row_data = mysql_fetch_assoc($data);
$totalRows_data = mysql_num_rows($data);

$query_usuario = "SELECT * FROM usuarios WHERE IdUnidad='$departamento2000' ORDER BY Nombre ASC";
