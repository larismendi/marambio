...
$query_tareasClientesList = "SELECT * FROM tareas WHERE IdEmpresa='$IdEmpresa' ORDER BY IdTarea DESC";
          ...
          <td>		  <div align="left">
            <select name="tareaCliente" class="texto_btgris" id="tareaCliente">
              <?php
				$conta=0;
				do {
					$query_tarea_reg = "    SELECT  id_tarea_registrada 
                                                                FROM    tareas_registradas 
                                                                WHERE   id_qna = '$IdQna' AND tarea='".$row_tareasClientesList['IdTarea']."' AND id_empleado = '".$row_supervisor['IdUsuario']."'";
