...
$query_f = "SELECT IdServicio, IdEmpresa, IdUnidad, IdGrupo, CodificacionComp, MesEjecucion, AnnoEjecucion, activo FROM tareas WHERE IdEmpresa = '".$_GET['id']."' ";
...
<table align="center">
	<tr>
    	<td align="right"><input type="button" value="Agregar tarea a la Empresa" onclick="javascript: document.location.href='agregarTareas.php?IdGrupo=<?php echo $row_f['IdGrupo']; ?>&IdEmpresa=<?php echo $row_f['IdEmpresa']; ?>'"></td>
    </tr>
    <tr>
    	<td>
            <table width="96%" align="center" class="sortable" border="1" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
              ...
              <tr>
                ...
                <td width="15%" align="center" class="texto_btgris">Agregar Tarea</td>
              </tr>
              </thead>
              <tbody>
              <?php 
                do { 
                    $query_e = "SELECT g.Nombre AS 'nombre1', e.Nombre AS 'nombre2', u.Nombre AS 'nombre3', s.Servicio FROM grupos AS g, empresas AS e, unidades AS u, servicios AS s WHERE g.IdGrupo = '".$row_f['IdGrupo']."' AND e.CodEmp = '".$_GET['id']."' AND u.IdUnidad = '".$row_f['IdUnidad']."' AND s.IdServicio = '".$row_f['IdServicio']."' ";
              ...
              ?>
                ...
                <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                 ...
                 <?php }?>
                    ...
                    <input name="IdTarea" type="hidden" id="IdTarea" value="<?php echo $row_f['IdTarea']; ?>">
                </form></td>
                <td><div align="center">
                <?php if($row_f['activo']==1) { ?>
                ...
                <td><div align="center"><a href="agregarTareas.php?IdGrupo=<?php echo $row_f['IdGrupo']; ?>&IdEmpresa=<?php echo $_GET['id']; ?>"><img src="images/edit_on.jpg" alt="Detalles" width="34" height="35" border="0"></a></div></td>
              </tr>
