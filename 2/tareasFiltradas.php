...
?>
                ...
                <table width="96%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
				  ...
				  ?>
                    ...
                    <td><div align="center">
					<?php if($row_tareas['activo']==1) { ?>
						<a href="personalAsignadoF.php?IdTarea=<?php echo $row_tareas['IdTarea']; ?>&IdGrupo=<? echo $IdGrupo; ?>"><img src="images/personas.gif" alt="Personal Asignado" width="34" height="35" border="0"></a>
					<? } ?>
					</div></td>
                    <td><div align="center"><a href="verTareaF.php?IdTarea=<?php echo $row_tareas['IdTarea']; ?>&IdGrupo=<? echo $IdGrupo; ?>"><img src="images/bot_verdetalle.gif" alt="Detalles" width="38" height="36" border="0"></a></div></td>
