...
$query_usuario = "SELECT * FROM usuarios WHERE Nivel = 4 OR Nivel = 3 OR Nivel = 5 ORDER BY Nombre ASC";
...
<?php include("includes/head.php"); ?>
                ...
                <p class="titulo">HOJA DE TIEMPO</p>
                <table width="36%" height="102"  border="0">
                  <tr>
                    <td><form name="form1" method="get" action="verQnaOtros.php">
                        <table width="79%"  border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
                          <tr>
                            <td width="40%" bgcolor="#E5E5E5" class="texto_btgris">Quincena</td>
                            <td width="60%"><select name="IdQna" class="texto_btgris" id="IdQna">
                                <?php
do {  
?>
