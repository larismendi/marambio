...
$(function(){
	$('#HorasEstimadas,#HorasEstimadas2,#HorasEstimadas3,#HorasEstimadas4,#HorasEstimadas5').change(function(){
		var nn0 = Number($('#HorasEstimadas').val()) + Number($('#HorasEstimadas2').val()) + Number($('#HorasEstimadas3').val()) + Number($('#HorasEstimadas4').val()) + Number($('#HorasEstimadas5').val());
...
?>
                ...
                <tr valign="baseline">
                  ...
                  <td><select name="IdUnidad" class="texto_gris" id="IdUnidad">
					...
					do {  
					?>
                    <option value="<?php echo $row_unidadesList['IdUnidad']?>">
						<?php echo $row_unidadesList['Nombre']?>
                    </option>
                    <?php
                ...
                <tr valign="baseline">
                  ...
                  <td>
                  <select name="IdServicio" class="texto_gris" id="IdServicio">
                    <?php
					...
					while ($row_servicios = mysql_fetch_array($serviciosList)){  
					?>
                    <option <?php if(isset($_POST['IdServicio']) && $_POST['IdServicio']==$row_servicios['IdServicio']){echo 'selected';}?> value="<?php echo $row_servicios['IdServicio']?>"><?php echo $row_servicios['Servicio']?></option>
                    <?php
					}
					?>
                  </select></td>
...
?>
				  ...
				  <td>
				    ...
				    <span class="texto_gris">/ </span>
                                    <select name="Mes" class="texto_gris" id="Mes">
				    ...
				    <span class="texto_gris">/ </span>
				    <select name="Anno" class="texto_gris" id="Anno">
                      <?php for($f = 0;$f < 2;$f++){?>
