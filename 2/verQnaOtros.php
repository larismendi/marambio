   ...
   <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
     <tr>
       ...
       <td width="10" class="texto_btgris">
         <div align="center"><?php if($row_mostrarAdm['Nombre']){ ?><a href="verQnaOtros.php?IdQnaSub=<?php echo $row_QnaSub2['IdQnaSub']; ?>&IdQna=<?php echo $row_QnaSub2['IdQna']; ?>&todas=1&IdUsuario=<?php echo $row_QnaSub2['IdUsuario']; ?>"><?php } ?><img src="images/CheckCerrado.gif" width="22" height="17" border="0"><?php if($row_mostrarAdm['Nombre']){ ?></a><?php } ?></div></td>
