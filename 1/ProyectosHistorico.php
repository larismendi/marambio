...
<link href="autoComplete/estilo_auto_relativo.css" rel="stylesheet" type="text/css">
                ...
                <table>
              	  <tr>
                    <td>
                     <form name="form2" id="form2" method="get" action="ProyectosHistorico2.php" onSubmit="return vali2()">
                        <table>
                            <tr>
                                <td><span class="texto_btgris">Busqueda de Proyectos:</span></td>
                            </tr>
                            <tr>
                                <td><input name="proyectoX" type="text" class="texto_gris" size="30" id="inputString" onkeyup="lookup(this.value);" onblur="fill();"> 
