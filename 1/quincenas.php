...
-->
                ...
                <table width="33%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
				  ...
				  if($totalRows_qna){
                  	do { ?>
                  <tr class="texto_gris">
                    <td height="32"><div align="center"><?=$row_qna['Quincena'];?></div></td>
                    <td><div align="center"><a href="editarQna.php?IdQna=<?=$row_qna['IdQna']?>"><?=$row_qna['Mes'];?> / <?=$row_qna['Anno'];?></a></div></td>
                    <td>
                      <div align="center"></div>
                      <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
                        <?php if($row_qna['activa']==1) { ?>
