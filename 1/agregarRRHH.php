...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$sqq = "SELECT Nombre FROM usuarios WHERE Nombre = '".$_POST['Nombre']."'";
	...
	if($valida == ""){
  		$insertSQL = sprintf("INSERT INTO usuarios (Nombre, Usuario, Pass, Nivel, Cargo, Telefono, Ext, IdUnidad) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
