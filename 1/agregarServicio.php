...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO servicios (CodCont, Servicio) VALUES (%s, %s)",
...
//-->
                ...
                <p><a href="servicios.php" class="texto_gris">&lt;&lt; Volver</a></p>
                <form action="" method="post" name="form1" onSubmit="MM_validateForm('CodCont','','R','Servicio','','R');return document.MM_returnValue">
                  <table border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
                    ...
                    <tr valign="baseline">
                      <td width="114" align="right" nowrap bgcolor="#E5E5E5" class="texto_btgris">Servicio:</td>
                      <td width="272"><input type="text" name="Servicio" value="" size="45"></td>
                    </tr>
                    <tr valign="baseline">
