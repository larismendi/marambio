        ...
        <table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="392" valign="top" ><div align="center">
                ...
                <p><?php if($row_supervisor['Usuario']=='mvaldez'||$row_supervisor['Usuario']=='mperez'){?><a href="agregarServicio.php" class="texto_btgris">Agregar Servicio &gt;&gt;</a><?php }?></p>
                <table width="62%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
                  <tr bgcolor="#E5E5E5" class="texto_btgris">
                    ...
                    <?php if($row_supervisor['Usuario']=='mvaldez'||$row_supervisor['Usuario']=='mperez'){?><td width="7%"><div align="center"><span class="Estilo1"></span></div></td>
                    <td width="7%"><div align="center"><span class="Estilo1"></span></div></td><?php }?>
                  </tr>
                  <?php do { ?>
                  <tr class="textogrande">
                    ...
                    <?php if($row_supervisor['Usuario']=='mvaldez'||$row_supervisor['Usuario']=='mperez'){?><td><a href="editarServicio.php?IdServicio=<?php echo $row_data['IdServicio']; ?>"><img src="images/edit_off.jpg" alt="Editar" width="34" height="35" border="0"></a></td>
                    <td><a href="eliminarServicio.php?IdServicio=<?php echo $row_data['IdServicio']; ?>"><img src="images/elim_on.jpg" alt="Eliminar" width="34" height="35" border="0"></a></td><?php }?>
                  </tr>
