...
if (isset($_GET['IdEmpresa'])) {
  $colname_tar = (get_magic_quotes_gpc()) ? $_GET['IdEmpresa'] : addslashes($_GET['IdEmpresa']);
}

$query_emp = "SELECT e.Nombre FROM empresas e WHERE e.IdEmpresa='".$_POST['IdEmpresa']."'";
                  ...
                  <tr>
                    <td width="872">
						<table width="914" border="0" class="datatable">
                            ...
                            <tbody>
                            <?php $ff = 0;
							$query_tar = "SELECT u.Nombre Usuario, t.* FROM tareas t LEFT JOIN usuarios u ON u.IdUsuario=t.IdLider WHERE e.CodEmp=t.IdEmpresa AND t.IdEmpresa = '$IdEmpresa' ORDER BY u.Nombre, t.IdEmpresa ASC";
