...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	$insertSQL = sprintf("UPDATE quincenas SET horlab=%s WHERE IdQna=%s",
...
$query_verifica = "SELECT * FROM quincenas WHERE IdQna='".$_GET['IdQna']."'";
                ...
                <form action="" method="post" name="form1" onSubmit="MM_validateForm('Anno','','R');return document.MM_returnValue">
                  <table width="277" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
                    <tr valign="baseline">
                      ...
                      <td width="195">
                      <select name="Quincena" class="texto_btgris" id="Quincena" disabled>
                        <option <?=$row_verifica['Quincena']=='1'?'selected':''?> value="1">1ra</option>
                        <option <?=$row_verifica['Quincena']=='2'?'selected':''?> value="2">2da</option>
                      </select></td>
                    </tr>
                    <tr valign="baseline">
                      <td align="right" nowrap bgcolor="#E5E5E5" class="texto_btgris">Mes:</td>
                      <td><select name="Mes" class="texto_btgris" id="Mes" disabled>
                        <option <?=$row_verifica['Mes']=='01'?'selected':''?> value="01">01</option>
                        <option <?=$row_verifica['Mes']=='02'?'selected':''?> value="02">02</option>
                        <option <?=$row_verifica['Mes']=='03'?'selected':''?> value="03">03</option>
                        <option <?=$row_verifica['Mes']=='04'?'selected':''?> value="04">04</option>
                        <option <?=$row_verifica['Mes']=='05'?'selected':''?> value="05">05</option>
                        <option <?=$row_verifica['Mes']=='06'?'selected':''?> value="06">06</option>
                        <option <?=$row_verifica['Mes']=='07'?'selected':''?> value="07">07</option>
                        <option <?=$row_verifica['Mes']=='08'?'selected':''?> value="08">08</option>
                        <option <?=$row_verifica['Mes']=='09'?'selected':''?> value="09">09</option>
                        <option <?=$row_verifica['Mes']=='10'?'selected':''?> value="10">10</option>
                        <option <?=$row_verifica['Mes']=='11'?'selected':''?> value="11">11</option>
                        <option <?=$row_verifica['Mes']=='12'?'selected':''?> value="12">12</option>
                      </select></td>
                    </tr>
                    <tr valign="baseline">
                      <td align="right" nowrap bgcolor="#E5E5E5" class="texto_btgris">A&ntilde;o:</td>
                      <td><input name="Anno" type="text" readonly class="texto_btgris" id="Anno" value="<?=$row_verifica["Anno"]?>" size="4" maxlength="4"></td>
                    </tr>
                    <tr>
                    	<td align="right" nowrap bgcolor="#E5E5E5" class="texto_btgris">Hora Laboral:</td>
                        <td><input name="horlab" type="text" class="texto_btgris" id="horlab" value="<?=$row_verifica["horlab"]?>" size="4" maxlength="4"></td>
                    </tr>
                    <tr valign="baseline">
                      <td align="right" nowrap bgcolor="#E5E5E5" class="texto_btgris">&nbsp;</td>
                      <td><input type="submit" class="texto_btgris" value="Editar registro">
                        <input name="IdQna" type="hidden" id="IdQna" value="<?=$row_verifica['IdQna']?>"></td>
                    </tr>
                  </table>
