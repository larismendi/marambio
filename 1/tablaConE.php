...
$query_f = "SELECT IdServicio, IdEmpresa, IdUnidad, IdGrupo, CodificacionComp, FEspanol, MesEjecucion, AnnoEjecucion, activo FROM tareas WHERE IdEmpresa = '".$_GET['id']."' ";
    	...
    	<td>
            <table width="96%" align="center" class="sortable" border="1" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
              ...
              <tr class="textogrande" onMouseOver="cambiar_color_over(this)" onMouseOut="cambiar_color_out(this)">
                <td height="37" class="texto_gris"><div align="center"><?php echo $row_f['CodificacionComp']; ?></div></td>
                <td class="texto_gris">
              <?php
                echo $row_e['nombre1'];
              ?>
