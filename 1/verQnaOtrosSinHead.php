...
<p align="left" class="textotitulos"><div id="results"></div>
   ...
   <tr bgcolor="#E5E5E5" class="texto_btgris">
	...
	?>
     <td width="20" bgcolor="#FFFFFF"><div align="center">31</div></td>
	 	<?php } ?>
	 <?php } ?>
     <td width="34" bgcolor="#FFFFFF"><div align="center">
       ...
       <td><div align="center">
         ...
         <?php } ?>  
           ...
           <input name="D31" type="text" class="texto_btgris" id="D31" value="<?php echo $row_QnaSub['D31']; ?>" size="1">
			...
			<?php } ?>
       <?php } ?>
       <td align="center"><input type="checkbox" name="aprobaReport[<?php echo $xx; ?>]" id="<?php echo $xx; ?>" value="<?php echo $row_QnaSub['IdQnaSub']; ?>" class="aproRep" title="Active para aprobación masiva" /></td>
       <td><div align="center">
   ...
   <tr bgcolor="#EEEEEE">
     ...
     <td><div align="center" class="texto_btgris"><strong><?php echo $totalHorasTotal; ?>
       ...
       <td><div align="center" class="texto_btgris"><strong><?php echo $totalD31; ?>
		   	...
		   	<?php } ?>
       <?php } ?>
       <td><div align="center" class="texto_btgris"><input type="button" name="actionAprobReport" id="actionAprobReport" value="&gt;&gt;" /><div class="suggestionsBox" id="suggestions" <?php if(isset($_SESSION['closeTooltip'])){echo 'style="display: none;"';}else{echo 'style="display: block;"';} ?>>
