...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
	...
	if($rrr != $_POST['RIF'] && $rrr != ""){
		$sfs = sprintf("SELECT CodEmp FROM empresas WHERE rif = %s",GetSQLValueString($_POST['RIF'], "text"));
	...
	$vaar2 = "";
	if($nombre_viejo != $_POST['Nombre'] && !isset($nopaso)){
                        ...
                        <td valign="top">
                          <table border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#E5E5E5">
                            ...
                            <tr valign="baseline">
                              ...
                              <td><input name="Nombre" type="text" class="texto_gris" value="<?=(isset($_POST['Nombre']))?$_POST['Nombre']:$row_data['Nombre'];?>" size="32" id="inputString" onkeyup="lookup(this.value);" onblur="fill();"></td>
                            </tr>
                            <tr valign="baseline">
