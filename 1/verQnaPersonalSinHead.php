...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE quincenasub SET D01=%s, D02=%s, D03=%s, D04=%s, D05=%s, D06=%s, D07=%s, D08=%s, D09=%s, D10=%s, D11=%s, D12=%s, D13=%s, D14=%s, D15=%s, D16=%s, D17=%s, D18=%s, D19=%s, D20=%s, D21=%s, D22=%s, D23=%s, D24=%s, D25=%s, D26=%s, D27=%s, D28=%s, D29=%s, D30=%s, D31=%s, A01=%s, A02=%s, A03=%s, A04=%s, A05=%s, A06=%s, A07=%s, A08=%s, A09=%s, A10=%s, A11=%s, A12=%s, A13=%s, A14=%s, A15=%s, A16=%s, A17=%s, A18=%s, A19=%s, A20=%s, A21=%s, A22=%s, A23=%s, A24=%s, A25=%s, A26=%s, A27=%s, A28=%s, A29=%s, A30=%s, A31=%s, APROBADO=%s WHERE IdQnaSub=%s",
                       GetSQLValueString($_POST['D01'], "double"),GetSQLValueString($_POST['D02'], "double"),
                       GetSQLValueString($_POST['D03'], "double"),GetSQLValueString($_POST['D04'], "double"),
                       GetSQLValueString($_POST['D05'], "double"),GetSQLValueString($_POST['D06'], "double"),
                       GetSQLValueString($_POST['D07'], "double"),GetSQLValueString($_POST['D08'], "double"),
                       GetSQLValueString($_POST['D09'], "double"),GetSQLValueString($_POST['D10'], "double"),
                       GetSQLValueString($_POST['D11'], "double"),GetSQLValueString($_POST['D12'], "double"),
                       GetSQLValueString($_POST['D13'], "double"),GetSQLValueString($_POST['D14'], "double"),
                       GetSQLValueString($_POST['D15'], "double"),GetSQLValueString($_POST['D16'], "double"),
                       GetSQLValueString($_POST['D17'], "double"),GetSQLValueString($_POST['D18'], "double"),
                       GetSQLValueString($_POST['D19'], "double"),GetSQLValueString($_POST['D20'], "double"),
                       GetSQLValueString($_POST['D21'], "double"),GetSQLValueString($_POST['D22'], "double"),
                       GetSQLValueString($_POST['D23'], "double"),GetSQLValueString($_POST['D24'], "double"),
                       GetSQLValueString($_POST['D25'], "double"),GetSQLValueString($_POST['D26'], "double"),
                       GetSQLValueString($_POST['D27'], "double"),GetSQLValueString($_POST['D28'], "double"),
                       GetSQLValueString($_POST['D29'], "double"),GetSQLValueString($_POST['D30'], "double"),
...
if($todas==1) {
    if($enviado!=1) {
        ...
        GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),
        GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),
        GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),
        GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),
	GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),GetSQLValueString($sii, "int"),
...
if (isset($Qna)) {
  $colname_qna = (get_magic_quotes_gpc()) ? $Qna : addslashes($Qna);
}
...
$query_QnaSub = "SELECT q.IdQna, q.Quincena, q.Mes, q.Anno, u.Nombre AS User, t.CodificacionComp AS codigo, s.Servicio, e.Nombre AS Empresa, qs.* FROM quincenasub AS qs LEFT JOIN quincenas AS q ON qs.IdQna = q.IdQna LEFT JOIN usuarios AS u ON qs.IdUsuario = u.IdUsuario LEFT JOIN tareas AS t ON t.IdTarea = qs.CodificacionComp LEFT JOIN servicios AS s ON s.IdServicio = t.IdServicio LEFT JOIN empresas AS e ON e.CodEmp = t.IdEmpresa WHERE qs.CodificacionComp = '".$colname_tar."' AND q.Quincena = '".$colname_qna."' AND qs.TipoTarea='1'";
...
<table width="100%" border="0" align="left">
   <tr>
     ...
     Servicio: <?=utf8_encode($row_QnaSub['Servicio']); ?><br>
     Empresa: <?php echo $row_QnaSub['Empresa']; ?><br>     
      <?php if ($row_QnaSub['Quincena'] == '1') {
                echo  $row_QnaSub['Quincena'].ra;
            } 
            if ($row_QnaSub['Quincena'] == '2')  {
                echo    $row_QnaSub['Quincena'].da; 
            }
	?>. Quincena de <?php 
            switch($row_QnaSub['Mes']){
		 case '1':
                    echo "Enero";        
                    break;
                 case '2':
		 ...
		 case '12':
                    echo "Diciembre";
                    break; }?> de <?php echo $row_QnaSub['Anno']; ?></span>
		<br>
     </td>
...
<p class="textoazul"><br/><br/>
    <span class="titulo">HORAS CLIENTE</span>
</p>
 <?php //TABLA DE TAREAS CLIENTES ?>
 <?php if($row_QnaSub>=1) { ?> 
<table height="52" border="1" style="width: 790px">
   <tr bgcolor="#E5E5E5" class="texto_btgris">
	...
	?>
	 ...
	 <?php if($NQda==2) { ?>
		...
		<?php
				$DiaCelda="31";	$diaColor=''; $ColorCelda=''; 
				$ORDENZZ=$MesQna . $DiaCelda;
	...
	?>
	 ...
	 <?php } ?>
       ...
       <select name="orden" id="orden" style="width:35px">
   ...
   ?>
	 ...
	 <?php if ($TotalHorasXX != '0')  { ?>
	      <?php  $xx++; ?>
<form name="form<?=$xx ?>" id="form<?=$xx ?>" method="POST" action="<?php echo $editFormAction; ?>">
<table border="1" style="width: 790px">
    <tr class="texto_gris" style="<?php if($row_QnaSub['APROBADO']){echo 'background:green';}?>">
       <td class="col1"><div align="center" class="texto_btgris">
       ...
       <td class="col3"><div align="center" class="texto_btgris">
       ...
       <td class="col4">
         ...
         <?php } ?>
		   <br>
           <input name="D01" type="text" style="width:20px" class="texto_btgris" id="D01" value="<?php echo $row_QnaSub['D01']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   <?php if($row_QnaSub['D02']!='') { ?>
         ...
         <?php } ?>
         <br>
         <input name="D02" type="text" style="width:20px" class="texto_btgris" id="D02" value="<?php echo $row_QnaSub['D02']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   <?php if($row_QnaSub['D03']!='') { ?>
           ...
           <?php } ?>
	   <br>
           <input name="D03" type="text" style="width:20px" class="texto_btgris" id="D03" value="<?php echo $row_QnaSub['D03']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
           ...
           <?php } ?>
	   <br>
           <input name="D04" type="text" style="width:20px" class="texto_btgris" id="D04" value="<?php echo $row_QnaSub['D04']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   <?php if($row_QnaSub['D05']!='') { ?>
           ...
           <?php } ?>
	   <br>
           <input name="D05" type="text" style="width:20px" class="texto_btgris" id="D05" value="<?php echo $row_QnaSub['D05']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   <?php if($row_QnaSub['D06']!='') { ?>
           ...
           <?php } ?>
	   <br>
           <input name="D06" type="text" style="width:20px" class="texto_btgris" id="D06" value="<?php echo $row_QnaSub['D06']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
           ...
           <?php } ?>
	   <br>
           <input name="D07" type="text" style="width:20px" class="texto_btgris" id="D07" value="<?php echo $row_QnaSub['D07']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
       ...
       <?php } ?>    
	   <br>
           <input name="D08" type="text" style="width:20px" class="texto_btgris" id="D08" value="<?php echo $row_QnaSub['D08']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   <?php if($row_QnaSub['D09']!='') { ?>
           ...
           <?php } ?>   
	   <br>
           <input name="D09" type="text" style="width:20px" class="texto_btgris" id="D09" value="<?php echo $row_QnaSub['D09']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A10'],1))) {echo "checked";} ?> name="A10" type="checkbox" id="A10">
           <?php } ?> 
	   <br>
           <input name="D10" type="text" style="width:20px" class="texto_btgris" id="D10" value="<?php echo $row_QnaSub['D10']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A11'],1))) {echo "checked";} ?> name="A11" type="checkbox" id="A11">
           <?php } ?>
	   <br>
           <input name="D11" type="text" style="width:20px" class="texto_btgris" id="D11" value="<?php echo $row_QnaSub['D11']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A12'],1))) {echo "checked";} ?> name="A12" type="checkbox" id="A12">
           <?php } ?> 
	   <br>
           <input name="D12" type="text" style="width:20px" class="texto_btgris" id="D12" value="<?php echo $row_QnaSub['D12']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
       <?php if($row_QnaSub['D13']!='') { ?>
           ...
           <?php } ?>  
	   <br>
           <input name="D13" type="text" style="width:20px" class="texto_btgris" id="D13" value="<?php echo $row_QnaSub['D13']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
       <?php if($row_QnaSub['D14']!='') { ?>
           ...
           <?php } ?>  
	   <br>
           <input name="D14" type="text" style="width:20px" class="texto_btgris" id="D14" value="<?php echo $row_QnaSub['D14']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==1) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A15'],1))) {echo "checked";} ?> name="A15" type="checkbox" id="A15">
           <?php } ?>
	   <br>
           <input name="D15" type="text" style="width:20px" class="texto_btgris" id="D15" value="<?php echo $row_QnaSub['D15']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
       <?php if($row_QnaSub['D16']!='') { ?>
           ...
           <?php } ?>
	   <br>
           <input name="D16" type="text" style="width:20px" class="texto_btgris" id="D16" value="<?php echo $row_QnaSub['D16']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
       <?php if($row_QnaSub['D17']!='') { ?>
           ...
           <?php } ?>  
	   <br>
           <input name="D17" type="text" style="width:20px" class="texto_btgris" id="D17" value="<?php echo $row_QnaSub['D17']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A18'],1))) {echo "checked";} ?> name="A18" type="checkbox" id="A18">
           <?php } ?>
	   <br>
           <input name="D18" type="text" style="width:20px" class="texto_btgris" id="D18" value="<?php echo $row_QnaSub['D18']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
       <?php if($row_QnaSub['D19']!='') { ?>
           ...
           <?php } ?>
	   <br>
           <input name="D19" type="text" style="width:20px" class="texto_btgris" id="D19" value="<?php echo $row_QnaSub['D19']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A20'],1))) {echo "checked";} ?> name="A20" type="checkbox" id="A20">
           <?php } ?> 
	   <br>
           <input name="D20" type="text" style="width:20px" class="texto_btgris" id="D20" value="<?php echo $row_QnaSub['D20']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
       <?php if($row_QnaSub['D21']!='') { ?>
           ...
           <?php } ?>  
	   <br>
           <input name="D21" type="text" style="width:20px" class="texto_btgris" id="D21" value="<?php echo $row_QnaSub['D21']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A22'],1))) {echo "checked";} ?> name="A22" type="checkbox" id="A22">
           <?php } ?> 
	   <br>
           <input name="D22" type="text" style="width:20px" class="texto_btgris" id="D22" value="<?php echo $row_QnaSub['D22']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A23'],1))) {echo "checked";} ?> name="A23" type="checkbox" id="A23">
           <?php } ?> 
	   <br>
           <input name="D23" type="text" style="width:20px" class="texto_btgris" id="D23" value="<?php echo $row_QnaSub['D23']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A24'],1))) {echo "checked";} ?> name="A24" type="checkbox" id="A24">
           <?php } ?>
	   <br>
           <input name="D24" type="text" style="width:20px" class="texto_btgris" id="D24" value="<?php echo $row_QnaSub['D24']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A25'],1))) {echo "checked";} ?> name="A25" type="checkbox" id="A25">
           <?php } ?>
	   <br>
           <input name="D25" type="text" style="width:20px" class="texto_btgris" id="D25" value="<?php echo $row_QnaSub['D25']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A26'],1))) {echo "checked";} ?> name="A26" type="checkbox" id="A26">
           <?php } ?> 
	   <br>
           <input name="D26" type="text" style="width:20px" class="texto_btgris" id="D26" value="<?php echo $row_QnaSub['D26']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A27'],1))) {echo "checked";} ?> name="A27" type="checkbox" id="A27">
           <?php } ?> 
	   <br>
           <input name="D27" type="text" style="width:20px" class="texto_btgris" id="D27" value="<?php echo $row_QnaSub['D27']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
       <td class="col4"><div align="center">
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A28'],1))) {echo "checked";} ?> name="A28" type="checkbox" id="A28">
           <?php } ?>
	   <br>
           <input name="D28" type="text" style="width:20px" class="texto_btgris" id="D28" value="<?php echo $row_QnaSub['D28']; ?>" size="1">
       </div></td>
       <?php } ?>
       <?php if($NQda==2) { ?>
   	   <?php if($ultimo_dia>=29) { ?>
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A29'],1))) {echo "checked";} ?> name="A29" type="checkbox" id="A29">
           <?php } ?>
	   <br>
           <input name="D29" type="text" style="width:20px" class="texto_btgris" id="D29" value="<?php echo $row_QnaSub['D29']; ?>" size="1">
       </div></td>
           <?php } ?>
       <?php } ?>
       <?php if($NQda==2) { ?>
	   ...
	   <input <?php if (!(strcmp($row_QnaSub['A30'],1))) {echo "checked";} ?> name="A30" type="checkbox" id="A30">
           <?php } ?>
	   <br>
           <input name="D30" type="text" style="width:20px" class="texto_btgris" id="D30" value="<?php echo $row_QnaSub['D30']; ?>" size="1">
       </div></td>
           <?php } ?>
       <?php } ?>
       <?php if($NQda==2) { ?>
       ...
       <td class="col4"><div align="center">
		 ...
		 <input <?php if (!(strcmp($row_QnaSub['A31'],1))) {echo "checked";} ?> name="A31" type="checkbox" id="A31">
           <?php } ?>  
	   <br>
           <input name="D31" type="text" style="width:20px" class="texto_btgris" id="D31" value="<?php echo $row_QnaSub['D31']; ?>" size="1">
       </div></td>
           <?php } ?>
       <?php } ?>
       <td class="col5" align="center"><input type="checkbox" name="aprobaReport[<?php echo $xx; ?>]" id="<?php echo $xx; ?>" value="<?php echo $row_QnaSub['IdQnaSub']; ?>" class="aproRep" title="Active para aprobación masiva" /></td>
...
<table style="width: 790px" border="1">
   <tr bgcolor="#EEEEEE">
       ...
       <td class="col5"><div align="center" class="texto_btgris"><?/*<input type="button" name="actionAprobReport" id="actionAprobReport" value="&gt;&gt;" />*/?><img src="images/CheckCerrado.gif" style="cursor:pointer" name="actionAprobReport" id="actionAprobReport" width="22" height="17" border="0"><div class="suggestionsBox" id="suggestions" <?php if(isset($_SESSION['closeTooltip'])){echo 'style="display: none;"';}else{echo 'style="display: block;"';} ?>>
                  ...
                  <div class="suggestionList" id="autoSuggestionsList">Aprobación de horas seleccionadas en reporte.<br/>
                  (Seleccione las horas a aprobar marcando el ckeckbox de la fila respectiva)</div></div></div></td>
       <td class="col5"><div align="center" class="texto_btgris"></div></td>
   </tr>
</table>
<?php } ?>
</body>
