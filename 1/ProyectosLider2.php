                    ...
                    <td width="872">					
						<table width="914" border="0" class="datatable">
                            ...
                            <tr onMouseOver="cambiar_color_over(this)" onMouseOut="cambiar_color_out(this)">
                            	<td><?php echo $row_tar['CodificacionComp']; ?></td>
                            	<td><?php echo $row_empresas['Nombre']; ?></td>
                                <td><?php echo $row_tar['MesEjecucion']."-".$row_tar['AnnoEjecucion']; ?></td>
                                <td><?php echo $TotalTotal." Horas."; ?></td>
                                <td><?php echo $row_serTT['Servicio']; ?></td>
							</tr>
                            ...
                            <tr>
                            	<td colspan="6" align="center">No se encontraron reportes asociados.</td>
							</tr>
							<?php	  
							  }
							}else{
