...
$query_super = "SELECT * FROM usuarios WHERE IdUsuario = '$IdUsuario'";
...
<table border="1">
   ...
   ?>
	 ...
	 ?>
      ...
      <td width="52" class="texto_btgris">         <div align="center"><a href="verQnaOtros.php?IdQnaSub=<?php echo $row_QnaSub['IdQnaSub']; ?>&IdQna=<?php echo $row_QnaSub['IdQna']; ?>&todas=1&IdUsuario=<?php echo $row_QnaSub['IdUsuario']; ?>"><img src="images/CheckCerrado.gif" width="22" height="8" border="0"></a><br>
       </div></td>
   ...
   <form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
     <tr>
       ...
       <td width="10" class="texto_btgris">
         <div align="center"><a href="verQnaOtros.php?IdQnaSub=<?php echo $row_QnaSub2['IdQnaSub']; ?>&IdQna=<?php echo $row_QnaSub2['IdQna']; ?>&todas=1&IdUsuario=<?php echo $row_QnaSub2['IdUsuario']; ?>"><img src="images/CheckCerrado.gif" width="22" height="17" border="0"></a></div></td>
