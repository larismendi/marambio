...
mysql_select_db($database_marambio, $marambio);
$query_userList = "SELECT * FROM usuarios";
...
<?php include("includes/head.php");?>
                ...
                <p><a href="tareasFiltradas.php?IdGrupo=<?php echo $IdGrupo; ?>"  class="texto_gris"><strong>&lt;&lt; Volver </strong></a></p>
...
?>
                ...
                <table width="50%"  border="1" bordercolor="#E5E5E5">
				  ...
				  ?>
                    ...
                    <td><a href="eliminarAsignado.php?IdPA=<?php echo $row_asig['IdPA']; ?>&IdTarea=<?php echo $IdTarea; ?>"><img src="images/elim_off.jpg" width="34" height="35" border="0"></a></td>
                  </tr>
