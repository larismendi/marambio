...
$CodSerFF=$row_proyectoMostar['IdServicio'];
$query_mostrarServicio = "SELECT IdServicio, Servicio FROM servicios WHERE IdServicio = '$CodSerFF'";
$mostrarServicio = mysql_query($query_mostrarServicio, $marambio) or die(mysql_error());
$row_mostrarServicio = mysql_fetch_assoc($mostrarServicio);
?>
<?php include("includes/head.php"); ?>
<p align="left" class="textotitulos">
	<span class="texto_btgris">
    	Proyecto: <strong><?php echo $row_proyectoMostar['CodificacionComp']; ?></strong><br>
        Servicio: <strong><?php echo $row_mostrarServicio['Servicio']; ?></strong><br>
        Grupo: <strong><?php echo $row_mostrarGrupo['Nombre'];; ?></strong><br>
		Empresa:<strong><?php echo $row_mostrarEmpresa['Nombre']; ?></strong></span>
        <br><br>
		<strong><a href="ProyectosHistorico.php" class="texto_gris">&lt;&lt; Volver </a></strong></p>
